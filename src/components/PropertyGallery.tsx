...
/**
 * Photo gallery for a listing detail page. There are no real photos yet
 * (see Listing.imageGradient), so each slide renders the same brand-toned
 * gradient placeholder — swap the slide content for real <Image> elements
 * once photography/Cloudinary is wired up, the carousel wiring itself
      ...
      <div className="overflow-hidden" ref={emblaRef}>
        <div className="flex">
          {slides.map((n) => (
            <div
              key={n}
              className={`relative aspect-[16/10] min-w-0 flex-[0_0_100%] bg-gradient-to-br ${listing.imageGradient}`}
            >
